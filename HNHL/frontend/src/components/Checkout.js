    ...
    return(
            <div className='container mt-4'>
                                        ...
                                        {cartItems&&
                                            cartData.map((item,index)=>{
                                                return(<tr>
                                                        ...
                                                        <p class="mb-2"><Link>{item.product.title}</Link></p>
                                                        </div>
                                                        </td>
                                                        <td class="align-middle">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colSpan='4' align='center'>
                                                ...
                                                {!showProceedToPayment && (
                                                    <Link to="/confirm-order" className='btn btn-success ms-1 disabled'>Proceed to Payment</Link>
                                                )}
                                            </td>
                                        </tr>
                                    </tfoot>
                ...
                <h3 className='mb-4'>Choose Deliver Address</h3>
                    <div>
                        <Link to="/customer/add-address" className='btn btn-outline-success mb-4'><i className='fa fa-plus-circle'></i>Add Address</Link>
                    </div>
