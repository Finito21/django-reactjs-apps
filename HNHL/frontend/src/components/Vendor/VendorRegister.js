                ...
                <div className='row'>
                    <div className='col-md-8 col-12 offset-2'>
                            ...
                            {errorMsg && <p className="text-danger">{errorMsg}</p>}
                                <form>
                                    ...
                                    <div className='mb-3'>
                                        ...
                                        <input type="email" onChange={inputHandler} value={registerFormData.last_name} name="last_name" className='form-control' id="lastName"/>
                                    </div>
                                    ...
                                    <div className='mb-3'>
                                        <div className='mb-3'>
                                            ...
                                            <input type="password"  onChange={inputHandler} name="password" value={registerFormData.password} className='form-control' id="pwd"/>
                                        </div>
                                    </div>
                        ...
                        <div className="switch d-flex align-items-center justify-content-center mt-3">
                            <button type="button" className="btn btn-primary" onClick={handleSwitchToggle}>Register as Client</button>
                        </div>
                    </div>
                </div>
