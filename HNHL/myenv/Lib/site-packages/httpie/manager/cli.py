...
COMMANDS["plugins"] = COMMANDS["cli"]["plugins"] = {
    ...
    "list": ["List all installed HTTPie plugins."],
}
...
def generate_subparsers(root, parent_parser, definitions, spec):
    ...
    actions = parent_parser.add_subparsers(dest=action_dest)
    for command, properties in definitions.items():
        ...
        for argument in properties:
            ...
            command_parser.add_argument(
                *flags, **map_qualifiers(argument, ARGPARSE_QUALIFIER_MAP)
            )
...
options = parser_to_parser_spec(
    parser, man_page_hint=man_page_hint, source_file=__file__
)
