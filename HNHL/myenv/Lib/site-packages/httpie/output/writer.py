...
def write_stream_with_colors_win(stream: "BaseStream", outfile: TextIO, flush: bool):
...
def build_output_stream_for_message(
    ...
    if (
        env.stdout_isatty
        and output_options.body
        and not output_options.meta
...
def get_stream_type_and_kwargs(
    ...
    if not env.stdout_isatty and not prettify_groups:
        ...
        stream_kwargs = {
            "chunk_size": (
                RawStream.CHUNK_SIZE_BY_LINE if is_stream else RawStream.CHUNK_SIZE
            )
        }
    else:
