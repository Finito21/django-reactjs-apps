...
BUNDLED_STYLES = {SOLARIZED_STYLE, AUTO_STYLE}
...
class ColorFormatter(FormatterPlugin):
    ...
    ) -> Tuple[pygments.formatter.Formatter, pygments.formatter.Formatter, bool]:
...
def make_style(name, raw_styles, shade):
    ...
    data = {"styles": {key: format_value(value) for key, value in raw_styles.items()}}
