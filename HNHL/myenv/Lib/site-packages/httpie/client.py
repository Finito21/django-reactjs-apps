...
def build_requests_session(
    ...
    https_adapter = HTTPieHTTPSAdapter(
        ...
        verify=verify,
        ssl_version=(
            AVAILABLE_SSL_VERSION_ARG_MAPPING[ssl_version] if ssl_version else None
        ),
    )
...
def transform_headers(
    ...
    apply_missing_repeated_headers(request.headers, prepared_request)
...
def apply_missing_repeated_headers(
    ...
    for prepared_name, prepared_value in prepared_request.headers.items():
        ...
        original_keys, original_values = zip(
            *filter(
...
def make_default_headers(args: argparse.Namespace) -> HTTPHeadersDict:
    default_headers = HTTPHeadersDict({"User-Agent": DEFAULT_UA})
