...
class ChunkedMultipartUploadStream(ChunkedStream):
    ...
    def __init__(
        self, encoder: "MultipartEncoder", event: Optional[threading.Event] = None
    ) -> None:
...
def _wrap_function_with_callback(
    func: Callable[..., Any], callback: CallbackT
) -> Callable[..., Any]:
...
def observe_stdin_for_data_thread(
    env: Environment, file: IO, read_event: threading.Event
) -> None:
